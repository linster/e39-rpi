...
@ConfiguredCarScope
actual class PlatformServiceList @Inject constructor(
    bluetoothService: BluetoothService,

    ibusInputEventCliPrinter: ca.stefanm.ibus.car.debugPrinters.IbusInputEventCliPrinter,
    ...
    actual val list : List<PlatformServiceGroup> = listOf(
